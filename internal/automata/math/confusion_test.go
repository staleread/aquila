...
//
// 	maxSub := core.Subscript(math.VectorSize)
//
...
// 			activeBits:  []core.Subscript{5},
// 			expectedBit: 0,
// 		},
// 		{
// 			name:        "Bits 3 and 4 are set -> 0^1 = 1",
// 			activeBits:  []core.Subscript{3, 4},
// 			expectedBit: 1,
// 		},
// 		{
// 			name:        "Bits 0, 1, 2, 3, 4 are set -> 1^1 = 0",
// 			activeBits:  []core.Subscript{0, 1, 2, 3, 4},
// 			expectedBit: 0,
// 		},
// 	}
//
